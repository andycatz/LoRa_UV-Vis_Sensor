...
# 5 "BH1750.c"
uint8_t bh1750Address=0b01000110;

void setBH1750Address(uint8_t add){
if(add>0){
bh1750Address = 0b10111000;
}
else{
bh1750Address=0b01000110;
}
}

void setBH1750ContinuousHResolutionMode(void){
BH1750WriteCommand(bh1750Address, 0b00010000);
}

void setBH1750ContinuousH2ResolutionMode(void){
BH1750WriteCommand(bh1750Address, 0b00010001);
}

void setBH1750ContinuousLResolutionMode(void){
BH1750WriteCommand(bh1750Address, 0b00010011);
}

void setBH1750OneTimeHResolutionMode(void){
BH1750WriteCommand(bh1750Address, 0b00100000);
}

void setBH1750OneTimeH2ResolutionMode(void){
BH1750WriteCommand(bh1750Address, 0b00100001);
}

void setBH1750OneTimeLResolutionMode(void){
BH1750WriteCommand(bh1750Address, 0b00100011);
}

void bh1750ChangeMeasurementTime(uint8_t mTime){

uint8_t highPart = (mTime && 0b11100000) >> 4;
highPart = highPart || 0b01000000;
BH1750WriteCommand(bh1750Address, highPart);


uint8_t lowPart = (mTime && 0b00011111);
lowPart = lowPart || 0b01100000;
...
char msb = I2C1_Read_Byte(1);
char lsb = I2C1_Read_Byte(1);
I2C1_Stop();
return msb*256u+lsb;
}
