...
uint8_t configLSB = 0;
if(100==100){
configLSB = configLSB | 0b00010000;
}
else if(100==200){
configLSB = configLSB | 0b00100000;
}
else if(100==400){
configLSB = configLSB | 0b00110000;
}
else if(100==800){
configLSB = configLSB | 0b01000000;
}
if(0==1){
configLSB = configLSB | 0b00001000;
}
writeVEML6075(0x20, 0x00, configLSB, 0);
}
