...
# 52 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC18F-K_DFP/1.4.87/xc8\pic\include\proc\pic18f46k22.h"
...
uint8_t txData[50];
uint8_t address[8] = {0x6E,0xDA,0x82,0x33,0x33,0x66,0xF5,0xE6};
...
txData[i+3] = address[i];
}
txData[11] = 0x05;


txData[12]=(uint8_t)((messageCount>>24)&0xFF);
txData[13]=(uint8_t)((messageCount>>16)&0xFF);
txData[14]=(uint8_t)((messageCount>>8)&0xFF);
txData[15]=(uint8_t)((messageCount & 0xFF));


txData[16]=(uint8_t)((batt>>8)&0xFF);
txData[17]=(uint8_t)(batt & 0xFF);


txData[18]=(uint8_t)((temp>>8)&0xFF);
txData[19]=(uint8_t)(temp & 0xFF);
...
txData[24]=(uint8_t)((uvaReading>>8)&0xFF);
txData[25]=(uint8_t)(uvaReading & 0xFF);


txData[26]=(uint8_t)((uvbReading>>8)&0xFF);
txData[27]=(uint8_t)(uvbReading & 0xFF);


txData[28]=(uint8_t)((comp1Reading>>8)&0xFF);
txData[29]=(uint8_t)(comp1Reading & 0xFF);


txData[30]=(uint8_t)((comp2Reading>>8)&0xFF);
txData[31]=(uint8_t)(comp2Reading & 0xFF);


txData[32]=(uint8_t)((vis>>8)&0xFF);
txData[33]=(uint8_t)(vis & 0xFF);
...
unsigned short int calcCRC = CRC16(txData, 50-2);
txData[49] = (calcCRC&0xFF00u)>>8u;
txData[48] = (calcCRC&0xFF);


if(0){
printf("Starting transmitter...\r\n");
}
LoRaStart(866.5, 0x55);
if(0){
printf("TXF: %f\r\n", LoRaGetFrequency());
}
LoRaClearIRQFlags();
LATEbits.LATE2=1;
LoRaTXData(txData, 50);
LATEbits.LATE2=0;
if(0){
...
uint16_t result = ADRESH * 256 + ADRESL;
return result;
}
